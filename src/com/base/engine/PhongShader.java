...
public class PhongShader extends Shader
{
	...
	private static DirectionalLight directionalLight = new DirectionalLight(new BaseLight(new Vector3f(1.f, 1.f, 1.f), 0.f), new Vector3f(0.f, 0.f, 0.f));
	...
	public static void setPointLights(PointLight[] pointLights)
	{
		...
		{
			System.err.println("Error: Too many pointlights. Max allowed: " + MAX_POINT_LIGHTS + ", you passed in " + pointLights.length);
	...
	public static void setSpotLights(SpotLight[] spotLights)
	{
		...
		{
			System.err.println("Error: Too many spotLights. Max allowed: " + MAX_SPOT_LIGHTS + ", you passed in " + spotLights.length);
			new Exception().printStackTrace();
			System.exit(1);
		}
